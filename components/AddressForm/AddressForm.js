...
class AddressForm extends Component{
    ...
    static defaultProps ={
    	...
    	validator: getRequiredValidator("Dirección","Descripción","Receptor","Teléfono")
    }
    submit = () =>{
    	this._form.submit();
    }
    			...
    			>
    				<Grid>
    					<ColFull>
    						...
    						<Field name="Dirección" label="Obligatorio" labelFor={addressInputId} isRequired>
    							<TextInput
    								id={addressInputId}
    								name="Dirección"
    								placeholder = "ej. 5av 5-55 Edificio Europlaza, Guatemala ciudad"
    							/>
    							<ErrorsBlock names={["Dirección"]} />
    						</Field>
    					</ColFull>
    					<ColFull>
    					...
    					<ColFull>
    						...
    						<Field name="Descripción" label="Obligatorio" labelFor={descriptionInputId} isRequired>
    							<TextInput
    								id={descriptionInputId}
    								name="Descripción"
    								placeholder = "ej. Casa, Trabajo."
    							/>
    							<ErrorsBlock names={["Descripción"]} />
    						</Field>
    					</ColFull>
						<ColFull>
